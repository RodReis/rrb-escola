...
- [ ] **Step 2: Criar o arquivo de setup**
...
- [ ] **Step 3: Ajustar a configuração do vitest**
...
- [ ] **Step 4: Verificar que os testes existentes continuam passando**
...
- [ ] **Step 2: Reexportar nos dois arquivos que declaram o tipo em duplicata**
...
- [ ] **Step 4: Adicionar a prop `loading` ao Button**
...
- [ ] **Step 6: Verificar que nenhum call site existente quebrou**
...
- [ ] **Step 5: Fechar a Fase 1 com a trava de qualidade**
...
- [ ] **Step 1: Migrar `aluno-row-actions.tsx`**
...
- [ ] **Step 2: Migrar `delete-template-button.tsx`**
...
- [ ] **Step 3: Migrar `mapping-form.tsx`**
...
- [ ] **Step 4: Verificar manualmente os três fluxos**
...
- [ ] **Step 5: Fechar a fase com a trava de qualidade**
...
- [ ] **Step 1: Verificar se a página é Server Component**
...
- [ ] **Step 2: Substituir os três `<form>` + `<button>` por `RowActionButton`**
...
- [ ] **Step 4: Fechar com a trava de qualidade**
...
- [ ] **Step 2: Converter as ações de linha para `RowActionButton`**
...
- [ ] **Step 3: Verificar manualmente cada grid**
...
- [ ] **Step 3: Remover os banners de query string**
...
- [ ] **Step 4: Ajustar o formulário de edição**
...
- [ ] **Step 6: Fechar com a trava de qualidade**
...
- [ ] **Step 1: Tratar um arquivo por vez, na ordem da lista**
...
- [ ] **Step 3: Migrar a action quando ela for contrato A/B/D**
...
- [ ] **Step 4: Remover os banners `?erro=` da página correspondente**

- [ ] **Step 5: Verificar manualmente cada tela após convertê-la**
...
- [ ] **Step 1: Renomear `reason` para `error`**
...
- [ ] **Step 4: Verificar que os testes existentes cobrem a mudança**
