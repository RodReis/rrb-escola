...
const FINANCEIRO_ITEMS: DropdownItem[] = [
  ...
  { href: "/financeiro/lancamentos/recorrentes", label: "Despesas recorrentes", iconName: "ReceiptText" },
  { href: "/financeiro/lancamentos/importar", label: "Importar previsto", iconName: "Receipt" },
  { href: "/financeiro/previsto-realizado", label: "Previsto × Realizado", iconName: "BarChart3" },
